...
object DiffTester {
    ...
    fun test(file1: VirtualFile, file2: VirtualFile, script: EditScript) {
        ...
        if (diffChanges != null) test(script.editOperations, diffChanges.toList())
        // TODO: else
    }

    fun test(semDiffChanges: List<EditOperation>, diffChanges: List<Diff.Change>) {
